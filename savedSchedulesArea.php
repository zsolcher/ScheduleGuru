...
<html>
    ...
    <div id="savedSchedulesArea">
     	<center>
			...
			<paper-checkbox checked label="Schedule 2"> </paper-checkbox> <br><br>
			
			<paper-checkbox checked label="Schedule 3"> </paper-checkbox> <br><br>
			
			<paper-checkbox checked label="Schedule 4"> </paper-checkbox> <br><br>
